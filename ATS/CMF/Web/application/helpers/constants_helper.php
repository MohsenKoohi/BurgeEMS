...
define('MAIN_ADDRESS',"localhost/Web/BurgeEMS/ATS/CMF/Web");
...
define ('CLASS_POST_DIR', HOME_DIR."/upload/class_post");
define ('CLASS_POST_URL', HOME_URL."/upload/class_post");
