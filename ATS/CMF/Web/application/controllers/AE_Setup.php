...
class AE_Setup extends CI_Controller {
	...
	function check_directories_permission()
	{
		...
		$dirs=array(LOG_DIR, CAPTCHA_DIR, POST_GALLERY_DIR, UPLOAD_DIR,CATEGORY_CACHE_DIR, CUSTOMER_IMAGES_DIR,CLASS_POST_DIR);
		$result=TRUE;
	...
	{	
		...
		$this->module_manager_model->install_module("time_manager");

		$this->module_manager_model->install_module("class_manager");

		$this->module_manager_model->install_module("reward_manager");

		$this->module_manager_model->install_module("question_collector");

		$this->module_manager_model->install_module("class_post_manager");
